...
// IWYU pragma: private, include "pinocchio/algorithm/regressor.hpp"
...
namespace pinocchio
{
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI const Data::RowVectorXs &
  computeKineticEnergyRegressor<
    context::Scalar,
    context::Options,
    JointCollectionDefaultTpl,
